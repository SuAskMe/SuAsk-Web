    ...
    <div class="control-panel-item">
        ...
        <div>
            ...
            <ul v-show="isOpen" class="menu-items">
                ...
                <control-panel-item class="menu-item" id="tea-question-old" text="已回答" jumpToPath="/ask-me/answered" />
                <control-panel-item class="menu-item" id="tea-question-top" text="置顶" jumpToPath="/ask-me/top" />
            </ul>
        </div>
        <control-panel-item id="tea-settings" icon="settings" text="设置" jumpToPath="/setting" />
        <control-panel-item id="tea-help" icon="question" text="帮助" jumpToPath="/help" />
    </div>
</template>

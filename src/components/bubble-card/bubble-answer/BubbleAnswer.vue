...
<template>
    <div class="bubble-answer" :style="isMine ? 'flex-direction: row-reverse;' : ''">
        <img @click.stop="clickAvatar(key)" :src="avatar" onerror="this.src='/default-avatar.png'; this.onerror=null;"
            class="avatar" :style="isMine ? 'margin-right: 72px;' : 'margin-left: 24px;'" />
        <div class="card-container" :style="isMine
            ...
            <div class="ans-body">
                ...
                <div v-show="imageContainer.hasImages" class="photos-container">

...
<template>
    <a-modal v-model:visible="visible" title-align="start" :fullscreen="fullscreen" :default-visible="true" width="60%"
        ...
        <a-input size="large" placeholder="问题标题" allow-clear v-model="title" style="width: 100%;"
        ...
        <a-checkbox v-if="teacherName" style="margin: 8px;" v-model="isPublic">是否公开</a-checkbox>
    </a-modal>
</template>

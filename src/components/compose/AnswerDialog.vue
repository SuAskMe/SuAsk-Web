        ...
        <div v-if="!draftVisible" class="compose">
            ...
            <div class="dialog">
                ...
                <div class="input-container">
                    ...
                    <div class="content">
                        <el-input v-model="answerContent.content" :autosize="{ minRows: 6, maxRows: 18 }"
                            type="textarea" placeholder="发表新回复..." />
                    </div>
                </div>
            </div>
            ...
            <div class="footer">
                ...
                <el-button @click="postAnswer" type="primary" round color="#71b6ff" style="color: white">发布</el-button>
            </div>
        </div>

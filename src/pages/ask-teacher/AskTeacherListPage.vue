            ...
            <el-scrollbar @scroll="checkStickyHeader">
                <div class="header" ref="stickyHeader">
                    <div
                        ...
                        :style="{ marginTop: deviceTypeStore.isMobile ? 0 : '20vh' }"
                    >
                        <div
                            v-if="true"
                            class="search-teacher-btn"
                ...
                <div class="teacher-list">
                    <TeacherCard
                        ...
                        :key="index"
                        :teacher="teacher"
                        :width="deviceTypeStore.isMobile ? '85%' : '40%'"
                        :teacher-key="{
...
const createFilter = (queryString: string) => {
    return (teacher: TeacherItem) => {
        return teacher.name.toLowerCase().indexOf(queryString.toLowerCase()) === 0
    }
}
...
const navigateTo = (key: any) => {
    if (key.perm == TeacherPerm.Private) {
        ...
        router.push({
            ...
            params: {
                teacher_id: String(key.teacherId),
...
const navigateToTeacherIndex = (key: any) => {
    ...
    // });
    router.push({ path: `/user/${key.teacherId}` })
}

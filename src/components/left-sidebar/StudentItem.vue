<template>
    <div class="control-panel-e">
        ...
        <control-panel-item class="control-panel-item" id="ask-history" icon="chat-history" text="历史提问"
            jump-to-path="/ask-history" />
        <control-panel-item class="control-panel-item" id="star" icon="star" text="我的收藏"
            jump-to-path="/my-favorite" />
        <control-panel-item class="control-panel-item" id="settings" icon="settings" text="设置"

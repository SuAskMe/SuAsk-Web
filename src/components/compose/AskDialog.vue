<template>
    <div class="dialog-container">
        <div v-if="!draftVisible" class="compose">
            <div class="header">
                <el-icon @click.stop="closeDialog" size="20px" :color="hoverColor" @mouseover="hoverColor = '#71b6ff'"
                    @mouseleave="hoverColor = '#000000'" style="cursor: pointer">
                    <Close />
                </el-icon>
            ...
            <div class="main">
                ...
                <div class="content">
                    <el-input v-model="questionContent.content" :autosize="{ minRows: 6, maxRows: 18 }" type="textarea"
                        placeholder="问题内容" />
        ...
        <div v-if="draftVisible" class="draft">
            <div class="header">
                <div class="left-item">
                    <el-icon @click="draftVisible = false" size="20px" :color="hoverColor"
            ...
            <el-checkbox-group v-model="deleteDrafts" class="draft-items" v-if="drafts.length != 0">
                <div v-for="draft in drafts" :key="draft.id" class="border">
                    <div @click="useDraft(draft)" class="draft-item">
                        ...
                        <img-list class="img-list" v-if="draft.imgList.length != 0"
                            :img-list="draft.imgList"></img-list>
        ...
        <el-dialog v-model="innerVisible" width="300px" :show-close="false" align-center :modal="false"
...
function useDraft(draft: Question) {
    ...
    for (const img of draft.imgList) {
        ...
        questionContent.value.fileList.push(

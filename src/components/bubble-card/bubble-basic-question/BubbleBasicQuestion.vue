    ...
    <div class="card-container" @click.stop="clickCard(key)">
            ...
            <div class="q-body">
                ...
                <div v-if="imageContainer.hasImages" class="photos-container">
                    <a-image-preview-group infinite>
                        <a-image @click.stop v-for="(img, index) in imagesUrls" :key="index" :src="img"
        ...
        <div v-if="!isSimple">
            <div v-if="answerNum" class="card-footer">
                ...
                <div v-if="answerNum > 2" style="font-size: 32px; color: #66b0ff">
                    ...
                </div>
...
<style scoped src="./BubbleBasicQuestion.css"></style>
